...
(function(ba) {
    ...
    function ga(b) {
        ...
        function p(a) {
            var j = n(k.paths, a);
            if (j && H(j) && 1 < j.length)
                return j.shift(), h.require.undef(a), h.makeRequire(null, {
                    skipMap: !0
                })([a]), !0
        }
        function g(a) {
            ...
            if (!W) {
                ...
                B(V, function(a) {
                    ...
                    if (a.enabled && (h.isDefine || l.push(a), !a.error))
                        ...
                        else if (!a.inited && (a.fetched && h.isDefine) && (e=!0, !h.prefix))
                            return i=!1
                });
                if (c && f.length)
                    return a = C("timeout", "Load timeout for modules: " + f, null,
                    f), a.contextName = h.contextName, w(a);
                i && v(l, function(a) {
                    F(a, {}, {})
                });
                if ((!c || b) && e)
            ...
            callPlugin: function() {
                ...
                s(d, "defined", u(this, function(f) {
                    ...
                    if (this.map.unnormalized) {
                        ...
                        d ? (this.map.url = h.nameToUrl(d), this.load()) : (l = u(this, function(a) {
                            this.init([], function() {
                                return a
                            }, null, {
                                enabled: !0
        ...
        h = {
            ...
            j) {
                function g(c, d, p) {
                    ...
                    if ("string" === typeof c) {
                        if (G(d))
                            return w(C("requireargs", "Invalid require call"), p);
                        if (a && t(L, c))
                            return L[c](m[a.id]);
                        if (e.get)
            ...
            completeLoad: function(a) {
                ...
                if (!b&&!t(q, a) && c&&!c.inited) {
                    if (k.enforceDefine && (!e ||!da(e)))
                        return p(a) ? void 0 : w(C("nodefine", "No define call for " + a, null, [a]));
    ...
    var e, x, y, D, I, E, N, J, r, O, ka = /(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)/mg, la = /[^.]\s*require\s*\(\s*["']([^'"\s]+)["']\s*\)/g, Q = /\.js$/, ia = /^\.\//;
    x = Object.prototype;
    var K = x.toString, fa = x.hasOwnProperty, ha = Array.prototype.splice, z=!!("undefined" !== typeof window && "undefined" !== typeof navigator && window.document), ea=!z && "undefined" !==
    typeof importScripts, ja = z && "PLAYSTATION 3" === navigator.platform ? /^complete$/ : /^(complete|loaded)$/, Y = "undefined" !== typeof opera && "[object Opera]" === opera.toString(), F = {}, s = {}, R = [], M=!1;
    if ("undefined" === typeof define) {
        ...
        function(b) {
            ...
            if (I = b.getAttribute("data-main"))
                return r = I, s.baseUrl || (E = r.split("/"), r = E.pop(), O = E.length ? E.join("/") + "/" : "./", s.baseUrl = O), r = r.replace(Q, ""), e.jsExtRegExp.test(r) && (r = I), s.deps = s.deps ? s.deps.concat(r) : [r], !0
        });
